...
def test_dataset(path):
    ...
    model = joblib.load(r'../model/VotingClassifiersoft.pkl')
    ...
    final.to_csv('../file/acp164.csv', header=None, index=None)
    print(y_lable.shape)
    print(y_predict_class.shape)
    print(y_predict_probo.shape)
...
if __name__ == '__main__':
    ...
    test_dataset(r'/data/tjzhang/luosu/LiuXuan/ACP240/csv/RFECV_Test_161.csv')
